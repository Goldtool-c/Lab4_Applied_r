                ...
                if(a<i) {
                    if ((point[0].doubleValue() >= this.viewport[0][0]) && (point[1].doubleValue() <= this.viewport[0][1]) &&
                        ...
                        if ((currentX != null) && (currentY != null)) {
                            ...
                            line.lineTo(line.getCurrentPoint().getX() + (diffX / 7), line.getCurrentPoint().getY() + (diffY / 7));
                            canvas.draw(line);
                            canvas.fill(line);
                            GeneralPath line1 = new GeneralPath();
                            canvas.setColor(Color.WHITE);
                            line1.moveTo(line.getCurrentPoint().getX(), line.getCurrentPoint().getY());
                            line1.lineTo(line1.getCurrentPoint().getX() + (diffX / 14), line1.getCurrentPoint().getY() + (diffY / 14));
                            canvas.draw(line1);
                            canvas.fill(line1);
                            GeneralPath line2 = new GeneralPath();
                            canvas.setColor(Color.RED);
                            line2.moveTo(line1.getCurrentPoint().getX(), line1.getCurrentPoint().getY());
                            line2.lineTo(line2.getCurrentPoint().getX() + (diffX / 7), line2.getCurrentPoint().getY() + (diffY / 7));
                            canvas.draw(line2);
                            canvas.fill(line2);
                            GeneralPath line3 = new GeneralPath();
                            canvas.setColor(Color.white);
                            line3.moveTo(line2.getCurrentPoint().getX(), line2.getCurrentPoint().getY());
                            line3.lineTo(line3.getCurrentPoint().getX() + (diffX / 14), line3.getCurrentPoint().getY() + (diffY / 14));
                            canvas.draw(line3);
                            canvas.fill(line3);
							...
							canvas.setColor(Color.white);
							line5.moveTo(line4.getCurrentPoint().getX(), line4.getCurrentPoint().getY());
							line5.lineTo(line5.getCurrentPoint().getX() + (diffX / 14), line5.getCurrentPoint().getY() + (diffY / 14));
							canvas.draw(line5);
							canvas.fill(line5);
							GeneralPath line6 = new GeneralPath();
							canvas.setColor(Color.red);
							line6.moveTo(line5.getCurrentPoint().getX(), line5.getCurrentPoint().getY());
							line6.lineTo(line6.getCurrentPoint().getX() + (diffX / 14), line6.getCurrentPoint().getY() + (diffY / 14));
							canvas.draw(line6);
							canvas.fill(line6);
							GeneralPath line7 = new GeneralPath();
							canvas.setColor(Color.white);
							line7.moveTo(line6.getCurrentPoint().getX(), line6.getCurrentPoint().getY());
							line7.lineTo(line7.getCurrentPoint().getX() + (diffX / 14), line7.getCurrentPoint().getY() + (diffY / 14));
							canvas.draw(line7);
							canvas.fill(line7);
							GeneralPath line8 = new GeneralPath();
							canvas.setColor(Color.red);
							line8.moveTo(line7.getCurrentPoint().getX(), line7.getCurrentPoint().getY());
							line8.lineTo(line8.getCurrentPoint().getX() + (diffX / 14), line8.getCurrentPoint().getY() + (diffY / 14));
							canvas.draw(line8);
							canvas.fill(line8);
							GeneralPath line9 = new GeneralPath();
							canvas.setColor(Color.white);
							line9.moveTo(line8.getCurrentPoint().getX(), line8.getCurrentPoint().getY());
							line9.lineTo(line9.getCurrentPoint().getX() + (diffX / 14), line9.getCurrentPoint().getY() + (diffY / 14));
							canvas.draw(line9);
							canvas.fill(line9);
							GeneralPath line10 = new GeneralPath();
							canvas.setColor(Color.red);
							line10.moveTo(line9.getCurrentPoint().getX(), line9.getCurrentPoint().getY());
							line10.lineTo(line10.getCurrentPoint().getX() + (diffX / 14), line10.getCurrentPoint().getY() + (diffY / 14));
							canvas.draw(line10);
							canvas.fill(line10);
